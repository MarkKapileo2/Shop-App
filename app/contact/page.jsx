        ...
        <div className='max-padd-container py-28'>
            <form className="flex flex-col items-center text-sm text-slate-800">
                ...
                <div className="max-w-96 w-full px-4">
                    ...
                    <div className="flex items-center mt-2 mb-4 h-10 pl-3 border border-slate-300 rounded-full focus-within:ring-2 bg-white transition-all overflow-hidden">
                    ...
                    <textarea rows="4" className="w-full mt-2 p-2 bg-transparent border border-slate-300 rounded-lg resize-none outline-none focus:ring-2 bg-white transition-all" placeholder="Enter your message" required></textarea>

                    <button type="submit" className="flex items-center justify-center gap-1 mt-5 btn-destructive w-full font-bold!">
                        Submit Form
