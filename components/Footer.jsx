...
function Footer() {
  return (
    <footer className="max padd-container text-sm pt-10 border-t borderslate-200">
      ...
      <p className="py-4 text-center border-t mt-6 border-slate-200">
        Copyright {new Date().getFullYear()} © <a href="https://prebuiltui.com">MarkK</a> All Right Reserved.
      </p>
    </footer>
  )
}
